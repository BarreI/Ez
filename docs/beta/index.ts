...
const Ez = (function(){
    ...
    const convart_to__el_Object = {
        ...
        convart:function(elements_array,path:string){
             ...
             */
            interface drug_and_drop_location{
                start:{
                    x:number,
                    y:number
                },
             ...
             * ドラッグ&ドロップ関数の引数
             */
            interface drug_and_drop {
                only?:"mouse"|"touch",
                get_only?:boolean,
                events?:{
                    drug?:(location:drug_and_drop_location,remove_event:()=>void)=>void,
                    drop?:(location:drug_and_drop_location,remove_event:()=>void)=>void,
                    move?:(location:drug_and_drop_location,remove_event:()=>void)=>void,
                    cancel?:(Location:drug_and_drop_location,remove_event:()=>void)=>void
                }
            ...
            interface el_Object {
                ...
                /**
                 * オブジェクトをドラック&ドロップできるようにする
                 */
                drug_and_drop(settings:drug_and_drop):void,
                /**
                 * htmlのelement一覧
                 */
                raw:Element[],
            ...
            let re:el_Object = {
                ...
                drug_and_drop:function(settings:drug_and_drop):void{
                    ...
                    interface Status_interface {
                        ...
                        location:drug_and_drop_location,
                    ...
                    const addEventListeners = {
                        ...
                        document_touchcancel(e){
                            if(status.touch.target == true){
                                Events.cancel(e);
                            };
                        },
                        element_touchstart(e){
